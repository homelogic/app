...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat Feb 16 00:55:04 2013
# Project:  HomeLogic.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++-4.6 CONFIG+=release -o Makefile HomeLogic.pro
#############################################################################
...
Makefile: HomeLogic.pro  c:/Qt/4.8.4/mkspecs/win32-g++-4.6/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
		...
		c:/Qt/4.8.4/lib/QtSerialPort.prl
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++-4.6 CONFIG+=release -o Makefile HomeLogic.pro
