...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat Feb 16 01:42:16 2013
# Project:  HomeLogic.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -config release -o Makefile HomeLogic.pro
#############################################################################
...
Makefile: HomeLogic.pro  c:/Qt/4.8.4/mkspecs/default/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
		...
		c:/Qt/4.8.4/mkspecs/win32-g++-4.6/qmake.conf \
	...
	$(QMAKE) -config release -o Makefile HomeLogic.pro
